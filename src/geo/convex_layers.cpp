...
// Based on paper "Maintenance of configurations in the plane" by Overmars and van Leeuwen, with
// some modifications This implementation only supports efficient (O(log^2n)) deletion of points,
// which is enough to compute nested convex hulls in O(nlog^2n). It should be possible to modify
